...
export function ConnectButton({
  ...
  const showDisclaimerAndConnect = () => {
    const disclaimer =
      'Please take note that this is a beta version feature and is provided on an "as is" and "as available" basis. Rootstock Explorer does not give any warranties and will not be liable for any loss, direct or indirect through continued use of this feature.';
...
export function WalletOptions() {
  ...
  if (!metamaskConnector) {
    console.warn(
      'MetaMask connector not found. Unable to render wallet options.',
    );
    return;
  }
