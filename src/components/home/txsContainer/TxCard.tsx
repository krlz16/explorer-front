        ...
        <div className="w-full text-left flex justify-between">
          ...
          <div className="text-sm text-white-400 mt-1">
            <div className="flex gap-1">
              Trom: <ToolTip text={tx.from} className="text-brand-orange" />
            </div>
            <div className="flex gap-1">
              To: <ToolTip text={tx.to} className="text-brand-orange" />
            </div>
          </div>
          <div className="flex flex-col justify-between">
            <div className="flex gap-2 text-sm">
              <div className="rounded-md bg-success text-success px-1">
                Success
              </div>
            ...
            <div className="w-full flex justify-start">
              <div className="bg-gray-600 rounded-full px-2 text-white-400 text-sm">
                {tx.txType}
              </div>
            </div>
          </div>
