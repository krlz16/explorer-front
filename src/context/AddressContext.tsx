...
interface DataContextType {
  ...
  setContractVerification: React.Dispatch<
    React.SetStateAction<IContractVerification | undefined>
  >;
}
...
export const AddressDataProvider = ({
  ...
  const [contractVerification, setContractVerification] = useState<
    IContractVerification | undefined
  >(undefined);
  return (
